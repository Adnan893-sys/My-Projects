 ...
 */
 ...
 LDI R31,0x00    ;inter
	...
	LDI R16,0xEA    ; put YA in R16
	OUT PORTB,R16   ;Send YA to portB
	LDI R16,0xA1    ; put JI in R16
	OUT PORTD,R16   ;Send JI to portD
	rcall FDelay    ; create delay to show
	rcall FDelay    ; create delay to show
	rcall FDelay    ; create delay to show
...
X1:
 ...
 division:     
  ...
  OUT PORTD,R31      ; show lower to nibbles on PORTB
