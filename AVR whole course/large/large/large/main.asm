...
.def  temp  =r16
.def  Largest_Value  =r17
.def  Largest_Value_Index  =r18
.def  Largest_Value_location =r20      // index largest value location
.def  increment_counter =r21         // index largest value location
...
loop:
	...
	cp  temp, Largest_Value         ; comapre temp value to the largets value
	brlt do_nothing                 ; if temp value is less than jump to do_nothing
	mov Largest_Value,temp          ; else mov temp value in the largest value
	mov Largest_Value_location,ZL   ; mov largest value location in register
    mov Largest_Value_index,increment_counter    ; mov largest value index in register
