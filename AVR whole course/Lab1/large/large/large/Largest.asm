...
.def  temp  =r16                      //keeping temp value
.def  Largest_Value  =r17            //keeping largest value
.def  Largest_Value_location  =r18   // keeping largest value location
.def  Largest_Value_Index  =r20      // index largest value location
...
loop:
	...
	cp  Largest_Value,temp          ;compare largest value to the tepm value obatined from table
	brge do_nothing                 ; if that value 
	mov Largest_Value,temp
	mov Largest_Value_location,ZL
	mov Largest_Value_counter,increment_counter
