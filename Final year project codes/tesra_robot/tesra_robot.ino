...
ros::Publisher chatter("rfid3", &str_msg);
...
ros::Subscriber<std_msgs::String> sub("robot3", &messageCb );
ros::Subscriber<std_msgs::String> Status("status3", &callback );
ros::Subscriber<std_msgs::Int32> motor("motor3", &Speed );
